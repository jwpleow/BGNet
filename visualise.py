...
def writeToPly(point_cloud, image, filename):
    ...
    with open(filename, 'w') as f:
        ...
        for c in range(point_cloud.shape[1]):
            for r in range(point_cloud.shape[0]):
                f.write(
                    f"{point_cloud[r, c, 0]} {point_cloud[r, c, 1]} {point_cloud[r, c, 2]} {image[r, c, 0]} {image[r, c, 0]} {image[r, c, 0]}\n")
...
class Visualiser:
    ...
    def update_pcd(self, disparity, img):
        ...
        # writeToPly(point_cloud, img, "test.ply")
        # pointcloud
